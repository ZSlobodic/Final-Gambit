    ...
    <tbody>
        @foreach ($backgrounds as $background)
            <tr>
                ...
                <td><a class="btn d-grid gap-2 btn-primary btn-rounded btn-sm fw-bold" href="{{ route('backgrounds.editBackground',$background->id) }}">Edit</a></td>
                <td><a class="btn d-grid gap-2 btn-danger btn-rounded btn-sm fw-bold" href="{{ route('backgrounds.deleteBackground',$background->id) }}" onclick="return confirm('Are you sure you want to delete {{$background->background_name}}? \nThis action is permananet and non-reversable.')">Delete</a></td>
            </tr>
        @endforeach
    </tbody>
</table>
